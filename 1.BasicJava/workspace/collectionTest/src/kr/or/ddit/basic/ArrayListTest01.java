...
public class ArrayListTest01 {
	...
	public static void main(String[] args) {
		// ArrayList 의 기본적인 사용법은 Vector와 같다.
		...
		System.out.println("ZZZZZZ 값 : " + list2.contains("ZZZZZZ"));
		System.out.println("CCCCCC 값 : " + list2.contains("CCCCCC"));
		
		// indexOf(비교객체) : 리스트에 '비교객체'가 있으면 '비교객체' 가 있는 index 값을 반환하고, 없으면 '-1' 을 반환한다.
